...
export default function DesktopClient({ initialPlaces }: { initialPlaces: Place[] }) {
  ...
  const [selectedPlace, setSelectedPlace] = useState<Place>(() => getRandomWellnessSpot(initialPlaces));
